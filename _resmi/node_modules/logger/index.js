const writers = require('./configs/writers.json');
const listeners = require('./configs/listeners.json');
...
function fileFormat(file) {
    if (file) {
        if (file.search('%s') > 0) {
            ...
            return util.format(listener.file, date);
        } else {
...
function writeFile(message, file) {
    ...
    fs.appendFile('logs/' + file, prefix + message + postfix, function (err) {
        ...
        log.info('logger', `Line added into file '${listener.file}'`);
    });
}
